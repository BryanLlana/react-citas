    ...
    return (
        <div className="mx-5 my-3 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold uppercase" onClick={()=>setPaciente(paciente)}>Editar</button>
                <button type="button" className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold uppercase" onClick={()=>eliminarPaciente(id)}>Eliminar</button>
            </div>
        </div>
    )
}
